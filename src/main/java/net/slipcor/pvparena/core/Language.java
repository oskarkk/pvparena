...
public final class Language {
    ...
    public enum MSG {
        ...
        GOAL_BLOCKDESTROY_TOSET("nulang.goal.blockdestroy.tosetflag", "Left click the block for team %1%&r"),
        ...
        GOAL_FLAGS_SET("lang.goal.flag.setflag", "%1% flag has been set"),
        GOAL_FLAGS_TOSET("lang.goal.flag.tosetflag", "Left-click the desired flag for the %1% team"),
        ...
        GOAL_LIBERATION_SET("nulang.goal.liberation.setbutton", "%1% button has been set"),
        ...
        GOAL_LIBERATION_TOSET("nulang.goal.liberation.tosetbutton", "Click on the button of the %1% team to register it"),
        GOAL_LIBERATION_BTN_NOTFOUND("nulang.goal.liberation.buttonnotfound", "%1% button doesn't exist"),
        GOAL_LIBERATION_BTN_REMOVED("nulang.goal.liberation.buttonremoved", "%1% button has been removed"),
